...
public class InventoryController {
    ...
    public int insertOrReplaceSparePart(Object[] values){
        final int res = DBManager.insertOrReplace("spareparts", new String[] { "supplierId", "partName", "receivedPrice", "sellingPrice", "currentQuantity", "initialQuantity" }, values, "on duplicate key update currentQuantity = currentQuantity + value(currentQuantity)");
