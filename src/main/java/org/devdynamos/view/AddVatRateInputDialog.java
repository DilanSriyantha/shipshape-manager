...
public class AddVatRateInputDialog extends JDialog {
    ...
    public AddVatRateInputDialog(DialogPositiveCallback<Integer> positiveCallback, DialogNegativeCallback<Integer> negativeCallback) {
    ...
    private void initInputRestrictions() {
        txtVat.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                if(txtVat.getText().isEmpty()) return;
                checkInputValidity(txtVat);
            }
    ...
    private void onOK() {
        ...
        positiveCallback.execute(this, Integer.parseInt(txtVat.getText()));
    }
