...
public class Employee {
    ...
    public Object[] toObjectArray() {
        return new Object[] { empName, email, contactNumber, jobRole, workArea };
    }
    ...
    public Object[][] getSkills2dArray() {
        Object[][] _skills = new Object[skills.size()][2];
            ...
            for (int j = 0; j < 2; j++) {
                switch (j){
                    case 0:
                        ...
                        break;
                    case 1:
                        _skills[i][j] = skills.get(i).getSkillDescription();
                        break;
                    default:
